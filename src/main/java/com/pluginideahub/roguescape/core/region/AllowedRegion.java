...
/**
 * Stage 3 — named allowed region. Region IDs are strings rather than RuneLite world point ints
 ...
 */
public final class AllowedRegion
{
	private final String id;
	private final String label;

	public AllowedRegion(String id, String label)
	{
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof AllowedRegion)) return false;
		AllowedRegion that = (AllowedRegion) o;
