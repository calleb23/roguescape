...
/**
 * QUARANTINE (locked 2026-07-03) — the old Scavenger scoring relics. These violate the relic
 * law ("every relic is a binary permit") with scoring biases, category limits and forbidden
 * categories, so <b>nothing drafts from this class</b>. The ideas stay browsable here; the good
 * ones get reborn as CURSES once mid-run curse accumulation lands.
 */
public final class LegacyRelics
{
	private LegacyRelics() {}

	/** The whole quarantined pool, in old display order. Nothing drafts from this. */
